...
/**
 * TabStyled - é uma componente de layout de abas com estilos em JSS. A anotação 
 * @injectSheet adiciona uma propriedade chamada classes contendo os nomes das classes 
 * geradas pelo JSS a partir do nome dos estilos criados
 */
@injectSheet(styles)
